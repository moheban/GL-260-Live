...
- The optional Combined Triple Axis snapshot is a compact first-page overview of the active cached plot, intended to show uptake-over-time context at a glance.
